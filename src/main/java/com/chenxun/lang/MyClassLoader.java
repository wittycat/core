...
//						}
	    ...
	    Object newInstance = classLoader.loadClass("com.chenxun.MyClassLoader").newInstance();
		
		System.out.println(newInstance.hashCode());
		MyClassLoader myClassLoader = new MyClassLoader();
		System.out.println(new MyClassLoader().hashCode());
		System.out.println(newInstance instanceof com.chenxun.lang.MyClassLoader);
